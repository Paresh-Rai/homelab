...
- Configured network settings as shown below:
  ...
  ![Network settings](../../images/lab01/network-settings.png)
...
- Promoted the server:
  ...
  ![Server settings](../../images/lab01/server-settings.png)
...
- Created two additional IPv4 scopes for different VLANs:
  ...
  ![DHCP VLAN 10](../../images/lab01/DHCP-VLAN10-01.png)
  ![DHCP VLAN 10 Options](../../images/lab01/DHCP-VLAN10-02.png)
  ![DHCP VLAN 20](../../images/lab01/DHCP-VLAN20-01.png)
  ![DHCP VLAN 20 Options](../../images/lab01/DHCP-VLAN20-02.png)
...
- Started the VM and verified DHCP assignment using:
  ...
  ![IP config](../../images/lab01/ipconfig.png)
...
- Confirmed the VM successfully joined the domain
  ...
  ![Client DHCP configuration](../../images/lab01/WM-CLIENT-VLAN20.png)
